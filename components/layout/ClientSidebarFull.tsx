...
const MENU: MenuSection[] = [
  {
    ...
    items: [
      ...
      { href: "/client/previsions-tresorerie", label: "Prévision de trésorerie", icon: TrendingUp },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/client/catalogue", label: "Catalogue services", labelKey: "clay.catalogue_services", icon: Package },
      { href: "/client/contacts", label: "Contacts clients", labelKey: "clay.client_contacts", icon: Users },
      { href: "/client/recurrences", label: "Récurrences", labelKey: "clay.recurrences", icon: Repeat },
      { href: "/client/relances", label: "Relances", labelKey: "clay.reminders", icon: Send },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/client/ifrs9-ecl", label: "Provision IFRS 9 (ECL)", labelKey: "clay.ifrs9_ecl", icon: Scale },
      { href: "/client/leases", label: "Contrats IFRS 16", labelKey: "clay.ifrs16_leases", icon: FilePen },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/client/gbc-ubo", label: "Beneficial Owners", labelKey: "clay.gbc_ubo", icon: Users },
      { href: "/client/gbc-consolidation", label: "Consolidation IFRS 10", labelKey: "clay.gbc_consolidation", icon: Building2 },
      { href: "/client/gbc-crs-fatca", label: "CRS / FATCA", labelKey: "clay.gbc_crs_fatca", icon: FileText },
      { href: "/client/gbc-pillar-two", label: "BEPS Pillar Two", labelKey: "clay.gbc_pillar_two", icon: Globe },
      ...
      { href: "/client/ifrs9-ecl", label: "Provision IFRS 9 (ECL)", labelKey: "clay.ifrs9_ecl", icon: Scale },
      { href: "/client/leases", label: "Contrats IFRS 16", labelKey: "clay.ifrs16_leases", icon: FilePen },
      { href: "/client/tiers-consolidation", label: "Tiers consolidation", labelKey: "clay.tiers_consolidation", icon: Building2 },
      { href: "/client/taux-change", label: "Taux de change (IAS 21)", labelKey: "clay.exchange_rate_ias21", icon: TrendingUp },
      { href: "/client/annual-return", label: "Annual Return FSC", labelKey: "clay.annual_return_fsc", icon: ClipboardList },
    ]
  },
  {
    ...
    items: [
      { href: "/client/mra-hub", label: "MRA Hub (Tax Calendar)", labelKey: "clay.mra_hub", icon: Calendar },
      { href: "/client/tva", label: "TVA MRA", labelKey: "tax.vat", icon: Receipt },
      { href: "/client/mra-tds", label: "TDS (Section 111A)", labelKey: "clay.mra_tds", icon: Banknote },
      { href: "/client/mra-cit", label: "CIT (Income Tax Return)", labelKey: "clay.mra_cit", icon: Calculator },
      { href: "/client/mra-roc", label: "ROC Annual Return", labelKey: "clay.mra_roc", icon: Building2 },
      { href: "/client/mra-sft", label: "SFT (AML/CFT)", labelKey: "clay.mra_sft", icon: ClipboardList },
  ...
  },
  {
    ...
    items: [
      { href: "/juridique", label: "Département Juridique", labelKey: "comp.legal_sidebar.dashboard", icon: Scale, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
      { href: "/juridique/dossiers", label: "Dossiers", labelKey: "comp.legal_sidebar.matters", icon: FolderKanban, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
      { href: "/juridique/departements", label: "Départements", labelKey: "comp.legal_sidebar.departments", icon: Lightbulb, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
      { href: "/juridique/conseil", label: "Conseil juridique", labelKey: "comp.legal_sidebar.advice", icon: MessageCircle, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
      { href: "/juridique/conseil-rh", label: "Conseil RH & Social", labelKey: "comp.legal_sidebar.advice_hr", icon: Users, visibleForRoles: ["client_admin", "direction", "rh", "rh_manager", "admin", "super_admin"] },
      { href: "/juridique/contentieux", label: "Contentieux", labelKey: "comp.legal_sidebar.litigation", icon: Gavel, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
      { href: "/juridique/contrats", label: "Générateur de contrats", labelKey: "comp.legal_sidebar.contract_generator", icon: FilePen, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
      { href: "/juridique/documents", label: "Documents", labelKey: "comp.legal_sidebar.documents", icon: FileText, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
      { href: "/juridique/conformite", label: "Conformité & délais", labelKey: "comp.legal_sidebar.compliance", icon: ClipboardList, visibleForRoles: ["client_admin", "direction", "admin", "super_admin"] },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/client/email-accounts", label: "Connexions emails", labelKey: "account.email_connections", icon: Mail },
      ...
      { href: "/client/direction/mra-credentials", label: "Connexion MRA", labelKey: "account.mra_connection", icon: KeyRound, visibleForRoles: ["direction","client_admin","admin","super_admin"] },
      { href: "/client/direction/bank-credentials", label: "Connexion banque", labelKey: "account.bank_connection", icon: Banknote, visibleForRoles: ["direction","client_admin","admin","super_admin"] },
