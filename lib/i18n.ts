...
const translations = {
  fr: {
    ...
    'home.smart_modules_desc': "Six modules integres pour couvrir l'ensemble de vos besoins comptables, RH et fiscaux",
  ...
  en: {
    ...
    'home.smart_modules_desc': 'Six integrated modules covering all your accounting, HR and tax needs',
