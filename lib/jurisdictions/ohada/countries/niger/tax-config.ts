...
export const NIGER_TAX_CONFIG: OhadaTaxConfig = {
  jurisdiction: 'NE',
  vatRates: [
  ...
  withholdingTaxes: [
    { code: 'WHT_SERVICES_RESIDENT', rate: 0.16, appliesTo: ['SERVICES'] },
  ...
  minimumCorporateTax: { rate: 0.015, minAmount: 1000000 },  // 1.5% du CA, min 1M XOF
}
