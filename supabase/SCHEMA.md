...
Documentation complète du schéma Supabase comptable après la refonte 2026 (migrations 196-207). À lire avant toute intervention sur le code comptable, le plan comptable mauricien, la classification bancaire ou le pipeline OCR.
...
- `tr_balance_check_insert` / `tr_balance_check_update` (mig 203)
...
- Classification rules R01-R06 (R05_INTERCO désactivée mig 205)
...
10. Backfill `montants_mur` (mig 199)
...
- Timeline génération "refonte bancaire" (196-207)
...
*Dernière mise à jour : 2026-04-23 — post-migration 207.*
