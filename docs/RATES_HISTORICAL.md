...
### 3.1 Seed initial (migration 206)

La migration `206_taux_change_historique.sql` insère des estimations au
...
- `supabase/migrations/206_taux_change_historique.sql` — création de la table.
