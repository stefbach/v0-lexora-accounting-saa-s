    ...
    <div style={{ background: "#F8F9FC", minHeight: "100vh", fontFamily: FONT }}>
      <header style={{ background: "#0B0F2E", padding: "28px 24px", color: "#E8EAFC" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            <Link href="/help" style={{ color: "#A8AFC7", textDecoration: "none" }}>
              Aide
            </Link>
            <ChevronRight size={14} aria-hidden />
            <Link href={`/help/${cat!.slug}`} style={{ color: "#A8AFC7", textDecoration: "none" }}>
              {cat!.title}
            </Link>
            <ChevronRight size={14} aria-hidden />
      ...
      <main style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px" }}>
        ...
        >
          <h1 style={{ fontSize: 30, fontWeight: 800, margin: 0, letterSpacing: "-0.02em", color: "#0B0F2E" }}>
            {article!.title}
          </h1>
          <p style={{ color: "#475569", margin: "8px 0 24px", fontSize: 14 }}>
            {article!.readingTime} de lecture · Catégorie {cat!.title}
          </p>
          <Article />
        </article>
        ...
        {related.length > 0 ? (
          <section style={{ marginTop: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: "#0B0F2E", marginBottom: 12 }}>
              Articles liés
            </h2>
