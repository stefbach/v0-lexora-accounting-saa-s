...
interface Societe {
  ...
  fsc_license_number?: string | null
  fsc_license_type?: string | null
...
export default function SocietesPage() {
  ...
  const openEdit = (s: Societe) => {
    setForm({ nom:s.nom, brn:s.brn||"", ern:s.ern||"", numero_tva_mra:s.numero_tva_mra||"", secteur_activite:s.secteur_activite||"", adresse:s.adresse||"", telephone:s.telephone||"", email:s.email||"", statut_tva:s.statut_tva||false, regime:s.regime||"domestic", devise_fonctionnelle:s.devise_fonctionnelle||"MUR", fsc_license_number:s.fsc_license_number||"", fsc_license_type:s.fsc_license_type||"", tax_residency_country:s.tax_residency_country||"MU" })
